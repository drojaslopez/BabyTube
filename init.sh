...
# 1. Crear directorio del proyecto y estructura OpenSpec
mkdir -p openspec

# 2. Generar openspec/spec.md
cat << 'EOF' > openspec/spec.md
...
# 3. Generar openspec/architecture.md
cat << 'EOF' > openspec/architecture.md
